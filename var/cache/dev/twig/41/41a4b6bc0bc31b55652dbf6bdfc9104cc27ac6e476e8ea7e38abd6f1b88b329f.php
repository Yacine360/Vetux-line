...
class __TwigTemplate_992d8d3c3d78af996cf5ee861cde9799d4ab306dcf820014cbf2c7e3a3f0d1f0 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Hello AlgorithmeController!";
    ...
    <h1>
    Juste pour voir si sa fonctionne :    
    ";
        // line 13
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["resultats"]) || array_key_exists("resultats", $context) ? $context["resultats"] : (function () { throw new RuntimeError('Variable "resultats" does not exist.', 13, $this->source); })()));
    ...
    ";
        ...
        // line 16
        echo "    </h1>
    <a href=\"csvfile/resultat-data.csv\" download=\"resultat-data.csv\">Download</a>
";
...
{% block title %}Hello AlgorithmeController!{% endblock %}
...
<style>
    ...
    <a href=\"csvfile/resultat-data.csv\" download=\"resultat-data.csv\">Download</a>
{% endblock %}
", "FrontEnd/resultat.html.twig", "/Users/enzocarpentier/Documents/COurs/Informatique/COurs/Symfony/Vetux-line/templates/FrontEnd/resultat.html.twig");
    }
}
