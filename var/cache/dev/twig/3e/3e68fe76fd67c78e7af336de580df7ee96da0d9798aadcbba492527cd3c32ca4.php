...
class __TwigTemplate_9b25767604b91463cc83ef569ba8f3b243b1e5302853c5c18d876032827bfb5d extends Template
{
    ...
    <h1> Juste pour voir si sa fonctionne : </h1>
    ";
        // line 12
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["merge"]) || array_key_exists("merge", $context) ? $context["merge"] : (function () { throw new RuntimeError('Variable "merge" does not exist.', 12, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["resultat"]) {
            // line 13
            echo "        <p> ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["resultat"], "GivenName", [], "any", false, false, false, 13), "html", null, true);
            echo " ! ✅  </p>
    ";
        }
...
";
    ...
    {
        return array (  113 => 18,  109 => 15,  100 => 13,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<style>
    ...
    <h1> Juste pour voir si sa fonctionne : </h1>
    {% for resultat  in merge %}
        <p> {{ resultat.GivenName }} ! ✅  </p>
    {% endfor %}
